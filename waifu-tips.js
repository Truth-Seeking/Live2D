...
$(document).on('copy', function() {
    showMessage('你都复制了些什么鸭，转载要记得加上出处哦~', 5000, true);
});
...
function waifuWelcome() {
    var text;
    var SiteIndexUrl = 'https://www.cnblogs.com/truth-seeking/'; // 手动指定主页
...
var waifuJson = {
    "mouseover": [{
        ...
        {
            "selector": "#htmer_time",
            "text": ["已经过了这么久了呀，日子过得好快呢", "<span style=\"color:#0099cc;\">2020</span> 是多久来着…<br>1，2，3……有好多好多天呢！"]
        },
        {
            "selector": ".updatelog",
            "text": ["这里记录着我搬家的历史呢"]
    ...
    "click": [{
        "selector": ".waifu #live2d",
        "text": ["点赞的小哥哥小姐姐最帅了！", "点我点我，我是不是很可爱~", "快来快来，哄我开心鸭"]
    }],
    "seasons": [{
            "date": "01/01",
        ...
        {
            "date": "10/01",
            "text": "<span style=\"color:#0099cc;\">国庆节</span>，今天是新中国的{year-1949}生日！祖国生日快乐！"
        },
        {
            "date": "11/05-11/12",
